...
HD_PWD='C:/Users/smdsbz/Projects/WasherController/WasherController.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ElevatorEmulator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ElevatorEmulator.tcl -notrace
