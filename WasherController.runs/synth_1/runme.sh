...
HD_PWD='C:/Users/smdsbz/Projects/WasherController/WasherController.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ElevatorEmulator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ElevatorEmulator.tcl
